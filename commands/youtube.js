...
module.exports = {
    ...
    run: async (client, message, args, { GuildDB }) => {
        ...
        .setAuthor("YouTube Together - EmeraldGltch", "https://cdn.discordapp.com/emojis/749289646097432667.png?v=1")
        .setColor("#FF0000")
        .setDescription(`
Using **EmeraldGltch's YouTube Together** you can watch YouTube with your friends in a Voice Channel. Click *Join YouTube Together* to join in!
